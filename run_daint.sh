...
echo "Go back home"
JOB_ID=lstm128_1layer_singlestep_250_2
JOB_DESC="lstm with 1 layer, 128 nodes each, only one epoch per batch, 250 epochs, trained on 13.h5 for another 250 epochs"
