...
\begin{frame}
  ...
  \begin{figure}[htb]
    \centering
    \subfloat[][]{\includegraphics[width =0.45\textwidth]{../RNN_out/lstm64_1layer_singlestep_250/loss-history.pdf}\label{a}}
    \subfloat[][]{\includegraphics[width =0.45\textwidth]{../RNN_out/lstm64_1layer_singlestep_250_2/loss-history.pdf}\label{a}}	
    \caption{test}
  \end{figure}
...
\begin{frame}
  ...
  \begin{figure}[htb]
    \centering
    \subfloat[][]{\includegraphics[width =0.45\textwidth]{../RNN_out/lstm64_3layers_singlestep_250/ROC-plot.pdf}\label{a}}	
    \subfloat[][]{\includegraphics[width =0.45\textwidth]{../RNN_out/lstm64_3layers_singlestep_250_2/ROC-plot.pdf}\label{b}}
...
\begin{frame}
  ...
  Use 40 training epochs per 10k chunk:
    ...
    \begin{figure}[htb]
    \centering
    \subfloat[][]{\includegraphics[width =0.45\textwidth]{../RNN_out/lstm64_3layers/loss-history.pdf}\label{a}}	
    \subfloat[][]{\includegraphics[width =0.45\textwidth]{../RNN_out/lstm64_3layers/ROC-plot-permanent.pdf}\label{b}}
...
\begin{frame}
  ...
  \begin{figure}[htb]
    ...
    \subfloat[][]{\includegraphics[width =0.45\textwidth]{../RNN_out/lstm128_1layer_singlestep_250_2/ROC-plot-permanent.pdf}\label{b}}
...
\begin{frame}
  ...
  \begin{figure}[htb]
    \centering
    \subfloat[][]{\includegraphics[width =0.45\textwidth]{../RNN_out/lstm128_1layer_singlestep_250_2/ROC-scatter-signal.pdf}\label{a}}	
    \subfloat[][]{\includegraphics[width =0.45\textwidth]{../RNN_out/lstm128_1layer_singlestep_250_2/ROC-scatter-background.pdf}\label{b}}
